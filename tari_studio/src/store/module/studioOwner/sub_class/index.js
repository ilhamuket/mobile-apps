  ...
  actions: {
    ...
    deletesDataSubclass: ({ commit }, payload) => {
      ...
      return new Promise((resolve, reject) => {
        ...
        axios
          .post("owner/sub-classes/my-sub/delestes", {
            id: params,
          })
          .then(res => {
    ...
    approvesDataSubclass: ({ commit }, payload) => {
      ...
      return new Promise((resolve, reject) => {
        const params = payload.map(x => x.id)
        axios
          .post("owner/sub-classes/my-sub/approves", {
            id: params,
          })
          .then(({ data }) => {
    ...
    editDataSubClass: ({ commit }, payload) => {
      ...
      return new Promise((resolve, reject) => {
        axios
          .patch(`owner/sub-classes/my-sub/${payload.id}`, {
            ...payload,
          })
          .then(res => {
