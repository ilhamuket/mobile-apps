...
class Data {
  ...
  static List<ProductModel> generateCategories() {
    return [
      ProductModel(1, "assets/images/shoes_1.png", "Pemula", "Men's Shoes",
          "men shoes", 99.56),
      ProductModel(2, "assets/images/shoes_2.png", "Menengah", "Men's Shoes",
          "men shoes", 137.56),
      ProductModel(3, "assets/images/shoes_3.png", "Mahir", "Men's Shoes",
          "men shoes", 99.56),
    ];
  }
}
