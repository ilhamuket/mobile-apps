    ...
    <v-row>
      ...
      >
        <v-card class="mx-auto">
          <v-img
            v-if="item.img"
            class="white--text layout__fhd align-end card__poluler--studio"
            width="400"
            height="400"
            :src="item.img.url"
  ...
  export default {
    ...
    computed: {
      computedList () {
        ...
        for (const item in this.studio) {
          if (Object.hasOwnProperty.call(this.studio, item)) {
